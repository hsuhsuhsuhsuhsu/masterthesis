...
library(joineR)
View(joineR::heart.valve)
help(heart.valve)

#author says there is something wrong with the example
#so i try to use joineR to demo it
devtools::install_github("nguforche/MEml")
install.packages("C:/Users/hsu/Downloads/bayou_2.1.1.tar.gz", repos=NULL, type="source" )
#install.packages("bayou")
#install.packages("TTR")
install.packages("ROCR")
install.packages("C:/Users/hsu/Downloads/DMwR_0.4.1.tar.gz", repos=NULL, type="source" )
library(MEml)
library(Formula)
library(gbm)
library(plyr)
